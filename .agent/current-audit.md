...
**Audit timestamp:** `2026-07-08T23-08-29-04-00`
...
`TheUnmappedHouse` was selected as the oldest eligible fallback. This pass keeps the story-authority direction but tightens the implementation handoff into a source manifest plus adapter consumer fixture gate.
...
LuminaryLabs-Publish/TheUnmappedHouse    selected fallback / oldest sampled alignment 2026-07-08T21-00-12-04-00
...
The highest-value next pass is not a story expansion or renderer rewrite. It is a pure story-authority layer with a `StorySourceManifest`, command/result records, projections, and a browser adapter plan that converts current DOM-owned actions into deterministic records.
