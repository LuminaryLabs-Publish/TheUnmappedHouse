...
**Audit timestamp:** `2026-07-08T23-19-33-04-00`
...
`TheUnmappedHouse` was selected for a central-ledger catch-up because its repo-local `.agent` had already advanced to `2026-07-08T23-08-29-04-00`, while the central ledger still showed `2026-07-08T21-00-12-04-00`. This pass preserves the story-source-manifest direction and adds an explicit browser-adapter readback fixture gate.
